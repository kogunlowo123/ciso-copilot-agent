"""CISO Copilot Agent - Domain-Specific Connectors."""
...
class SnowflakeConnector:
    """Domain-specific connector for snowflake integration with CISO Copilot Agent."""
...
class TableauConnector:
    """Domain-specific connector for tableau integration with CISO Copilot Agent."""
...
class SalesforceConnector:
    """Domain-specific connector for salesforce integration with CISO Copilot Agent."""
...
class WorkdayConnector:
    """Domain-specific connector for workday integration with CISO Copilot Agent."""
...
class JiraConnector:
    """Domain-specific connector for jira integration with CISO Copilot Agent."""
